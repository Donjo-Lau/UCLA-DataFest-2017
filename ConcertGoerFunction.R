...
mydata <- read_tsv("/Users/donjolau/Desktop/DataFest 2017/data.txt")
subset <- read_csv("/Users/donjolau/Desktop/DataFest 2017/small subsample.csv")
dest <- read_tsv("/Users/donjolau/Desktop/DataFest 2017/dest.txt")
events <- read_csv("/Users/donjolau/Desktop/DataFest 2017/events.csv")
merged <- merge(data1, dest, by="srch_destination_id") #main merge
smallMerged <- merge(subset, dest, by = "srch_destination_id")
